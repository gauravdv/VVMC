...
Public Class frm_CouponCollection_Only
    ...
    Dim _ConEmpWayBillOnly As String
    Dim _TotalAmountOnly As String
    ...
    Private Sub update_WayBillMst()
        ...
        _ConEmpWayBillOnly = cmb_WayBillNo.Text
        If Not _ConEmpWayBillOnly = "" Then
            Sql = "UPDATE tbl_waybill_mst SET  fldi_coupon_close_userid = '" + _UserId + "', fldi_collection_close_userid ='" + _UserId + "', 
                flddt_waybill_open_close_datetime = '" + CurretDate + "' WHERE fldv_waybill_no = '" + _ConEmpWayBillOnly + "' "
            Try
                conn.Open()
                dbcomm = New MySqlCommand(Sql, conn)
                dbcomm.ExecuteNonQuery()
