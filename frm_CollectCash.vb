...
Public Class frm_CollectCash
    ...
    Dim _TotalCouponAmount As Int64 = frm_CouponCollection._TotalCouponAmount
    Dim TotalCollection As Int64 = frm_Auditing.TotalCollection
    ...
    Dim _ConEmpWayBill As String = frm_CouponCollection._ConEmpWayBill
