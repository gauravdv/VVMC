...
using java.awt.Font;
using java.awt.GridBagConstraints;
using java.awt.GridBagLayout;
...
using javax.comm.CommPortIdentifier;
using javax.comm.SerialPort;
using javax.swing.JApplet;
...
using javax.swing.JTable;
using javax.swing.JTextArea;
using javax.swing.JTextField;
using javax.swing.event.DocumentEvent;
using javax.swing.table.DefaultTableModel;
using javax.swing.table.TableColumn;
using javax.swing.table.TableColumnModel;
using javax.swing.table.TableModel;
using javax.swing.text.Document;
public class DataVoice : JApplet, java.awt.event.ActionListener, javax.comm.SerialPortEventListener, javax.swing.event.TableModelListener, java.awt.event.KeyListener {
    ...
    public DataVoice() {
        this.cmbPortList = new JComboBox();
        this.cmbConductor = new JComboBox();
        this.lblHeader = new JLabel("Vasai-Virar Muncipal Transport (VVMT)");
        this.lblSerialPort = new JLabel("Select Serial Port");
        this.lblWayBill = new JLabel("WayBill");
        this.lblTicket = new JLabel("Ticket");
        this.lblSmartCard = new JLabel("Smart Card");
        this.lblCollectionDate = new JLabel("Collection Date");
        this.lblConductor = new JLabel("Select Conductor");
        this.lblCouponCollectiondate = new JLabel("Date");
        this.lblTotalTicketCollection = new JLabel("Total Ticket Collection");
        this.lblTotalTopUpCollection = new JLabel("Total Topup Collection");
        this.lblTotalCollection = new JLabel("Total Collection");
        this.lblTotalCollectionAmt = new JLabel("Total Collection");
        this.lblTotalCouponData = new JLabel("Total Ticket Amount");
        this.btnCollectData = new JButton("Collect Ticket");
        this.btnWayBill = new JButton("Collect WayBill");
        this.btnUploadData = new JButton("Upload Ticket");
        this.btnDelWayBill = new JButton("Delete Waybill");
        this.btnEraseData = new JButton("Erase Ticket");
        this.btnWayBillNumber = new JButton("Get Waybill");
        this.btnUploadWayBill = new JButton("Upload Waybill");
        this.btnCollectCash = new JButton("Collect Cash");
        this.btnGetTotalAmount = new JButton("Get Total Amount");
        this.btnCauculateAmount = new JButton("Upload Collection");
        this.btnGetConductorCoupon = new JButton("Get Conductor Ticket Details");
        this.btnUploadCouponData = new JButton("Upload Ticket Data");
        this.btnGetCouponAmount = new JButton("Get No. of Tickets");
        this.btnGetCardTopUp = new JButton("Collect Card Data");
        this.btnUploadCardData = new JButton("Upload Card Data");
        this.btnCouponCollectCash = new JButton("Collect Cash");
        this.txtWayBillNo = new JTextField(10);
        this.txtCashCollDate = new JTextField(10);
        this.txtCashCollected = new JTextField(10);
        this.txtCouponCollectDate = new JTextField(10);
        this.txtTotalTicketCollection = new JTextField(10);
        this.txtTotalTopupCollection = new JTextField(10);
        this.txtTotalCollection = new JTextField(10);
        this.txtTotalCouponCollection = new JTextField(10);
        this.progressBar = new javax.swing.JProgressBar();
        this.txtData = new JTextArea(5, 75);
        this.txtSmartCardData = new JTextArea(2, 75);
        this.menuBar = new javax.swing.JMenuBar();
        this.menuAuditing = new JMenu("Auditing");
        this.menuMasters = new JMenu("Masters");
        this.menuItemCollection = new JMenuItem("ETIM Ticket");
        this.menuItemCreateWaybill = new JMenuItem("Waybill Creation");
        this.menuItemCouponTicket = new JMenuItem("Ticket Collection");
        this.panelAuditing = new JPanel(new GridBagLayout());
        this.panelWaybillTicket = new JPanel(new GridBagLayout());
        this.panelButton = new JPanel(new GridBagLayout());
        this.panelMain = new JPanel(new GridBagLayout());
        this.panelHeader = new JPanel(new GridBagLayout());
        this.panelProgress = new JPanel(new GridBagLayout());
        this.panelFrontPage = new JPanel(new GridBagLayout());
        this.panelHeaderAll = new JPanel(new GridBagLayout());
        this.panelCreateWaybill = new JPanel(new GridBagLayout());
        this.panelDisplayCont = new JPanel(new GridBagLayout());
        this.panelGetWayBill = new JPanel(new GridBagLayout());
        this.panelWayBillUpload = new JPanel(new GridBagLayout());
        this.panelCashCollection = new JPanel(new GridBagLayout());
        this.panelGetCash = new JPanel(new GridBagLayout());
        this.panelCashDate = new JPanel(new GridBagLayout());
        this.panelCashDisp = new JPanel(new GridBagLayout());
        this.panelCoupon1 = new JPanel(new GridBagLayout());
        this.panelCoupon2 = new JPanel(new GridBagLayout());
        this.panelCoupon3 = new JPanel(new GridBagLayout());
        this.panelCouponButton = new JPanel(new GridBagLayout());
        this.panelTicketCollection = new JPanel(new GridBagLayout());
        this.lblParticulars = new JLabel("Particulars");
        this.lblCount = new JLabel("Count");
        this.lblAmount = new JLabel("Amount");
        this.lblP1000 = new JLabel("1000 x");
        this.lblP500 = new JLabel("500 x");
        this.lblP100 = new JLabel("100 x");
        this.lblP50 = new JLabel("50 x");
        this.lblP20 = new JLabel("20 x");
        this.lblP10 = new JLabel("10 x");
        this.lblP5 = new JLabel("5 x");
        this.lblP2 = new JLabel("2 x");
        this.lblP1 = new JLabel("1 x");
        this.lblPS10 = new JLabel("10 x");
        this.lblPS5 = new JLabel("5 x");
        this.lblPS2 = new JLabel("2 x");
        this.lblPS1 = new JLabel("1 x");
        this.lblPS50 = new JLabel("0.5 x");
        this.lblDivisionCoins = new JLabel("Coins");
        this.lblToTalAmtCol = new JLabel("Total Amount Collected");
        this.lblAmtDifference = new JLabel("Difference");
        this.txtAmtDifference = new JTextField(10);
        this.txtPC1000 = new JTextField(5);
        this.txtPC1500 = new JTextField(5);
        this.txtPC100 = new JTextField(5);
        this.txtPC50 = new JTextField(5);
        this.txtPC20 = new JTextField(5);
        this.txtPC10 = new JTextField(5);
        this.txtPC5 = new JTextField(5);
        this.txtPC2 = new JTextField(5);
        this.txtPC1 = new JTextField(5);
        this.txtPCs10 = new JTextField(5);
        this.txtPCs5 = new JTextField(5);
        this.txtPCs2 = new JTextField(5);
        this.txtPCs1 = new JTextField(5);
        this.txtPCs05 = new JTextField(5);
        this.txtPA1000 = new JTextField(5);
        this.txtPA1500 = new JTextField(5);
        this.txtPA100 = new JTextField(5);
        this.txtPA50 = new JTextField(5);
        this.txtPA20 = new JTextField(5);
        this.txtPA10 = new JTextField(5);
        this.txtPA5 = new JTextField(5);
        this.txtPA2 = new JTextField(5);
        this.txtPA1 = new JTextField(5);
        this.txtPCsA10 = new JTextField(5);
        this.txtPCsA5 = new JTextField(5);
        this.txtPCsA2 = new JTextField(5);
        this.txtPCsA1 = new JTextField(5);
        this.txtPCsA05 = new JTextField(5);
        this.txtTotalAmtCol = new JTextField(5);
        this.input = null;
        this.output = null;
        this.logText = "";
        this.concatDeviceData = "";
        ...
        this.ticketData = 68;
        this.wayBillData = 66;
        this.ticketEraseData = 69;
        this.tcketEraseData1 = 46;
        this.wayBillEraseData = 67;
        this.wayBillUpload = 65;
        this.cardTopUp = 78;
        this.endOfString = 4;
        this.taxFactor = "00.15";
        this.etmNumberValue = "";
        this.dataType = "";
        this.commandString = 0;
        this.chkWayBillSend = 0;
    }
    ...
    public void init() {
        ...
        while (portList.hasMoreElements()) {
            ...
            if ((portId.getPortType() == 1)) {
                this.cmbPortList.addItem(portId.getName());
                System.out.println(portId.getName());
            }
            
        }
        
        this.menuBar.add(this.menuAuditing);
        this.menuBar.add(this.menuMasters);
        this.menuAuditing.add(this.menuItemCollection);
        this.menuMasters.add(this.menuItemCreateWaybill);
        this.menuMasters.add(this.menuItemCouponTicket);
        this.menuItemCollection.addActionListener(new DataVoice.MenuAction());
        this.menuItemCreateWaybill.addActionListener(new DataVoice.MenuAction());
        this.menuItemCouponTicket.addActionListener(new DataVoice.MenuAction());
        setJMenuBar(this.menuBar);
        this.tblWayBillDetails = new JTable();
        this.tblWayBillDetails.setFillsViewportHeight(false);
        this.tblWayBillDetails.setAutoCreateRowSorter(true);
        this.tblWayBillDetails.setSelectionMode(0);
        this.tblWayBillDetails.setCellSelectionEnabled(false);
        this.tblWayBillDetails.setRowSelectionAllowed(true);
        this.tblWayBillDetails.setAutoResizeMode(0);
        JScrollPane localJScrollPane1 = new JScrollPane(this.tblWayBillDetails);
...
getConductorDetails();
Unknownclass MyDocumentListener : javax.swing.event.DocumentListener {
    ...
    public void insertUpdate(DocumentEvent paramDocumentEvent) {
        this.updateAmount(paramDocumentEvent, "Insert");
    }
    
    public void removeUpdate(DocumentEvent paramDocumentEvent) {
        this.updateAmount(paramDocumentEvent, "Remove");
    }
    ...
    public void updateAmount(DocumentEvent paramDocumentEvent, String paramString) {
        try {
            ...
            this.getTotalAmoutCollected(str3);
        }
    ...
    public void getTotalAmoutCollected(String paramString) {
        try {
            Float localFloat1 = Float.valueOf((Float.parseFloat(txtPA1000.getText().trim()) 
                            + (Float.parseFloat(txtPA1500.getText().trim()) 
                            + (Float.parseFloat(txtPA100.getText().trim()) 
                            + (Float.parseFloat(txtPA50.getText().trim()) 
                            + (Float.parseFloat(txtPA20.getText().trim()) 
                            + (Float.parseFloat(txtPA10.getText().trim()) 
                            + (Float.parseFloat(txtPA5.getText().trim()) 
                            + (Float.parseFloat(txtPA2.getText().trim()) 
                            + (Float.parseFloat(txtPA1.getText().trim()) 
                            + (Float.parseFloat(txtPCsA10.getText().trim()) 
                            + (Float.parseFloat(txtPCsA5.getText().trim()) 
                            + (Float.parseFloat(txtPCsA2.getText().trim()) 
...
private class MenuAction : java.awt.event.ActionListener {
            ...
            if ((j == 3)) {
                ...
                try {
                    ...
                    if ((m > 0)) {
                        ...
                        localFloat6 = Float.valueOf(((localFloat1.floatValue() + localFloat4.floatValue()) 
    ...
    public void calculateCouponCollectAmount() {
        try {
            ...
            Float localFloat = Float.valueOf(0);
            for (int j = 0; (j < i); j++) {
...
//btnWayBill
        else if ((paramActionEvent.getSource() == btnWayBill))
        {
            ...
            if ((paramActionEvent.getSource() == btnUploadCardData)) {
                btnUploadCardData.setEnabled(false);
                ...
                int i17;
                int i16;
                if ((paramActionEvent.getSource() == btnUploadData)) {
                    ...
                    if (!str2.equals("")) {
                        ...
                        try {
                            ...
                            int i14 = Array.getLength(localObject19);
                            ...
                            for (int i15 = 0; (i15 < i14); i15++) {
                                try {
                                    ...
                                    if ((!((String)(localObject21)).equals("") 
                                                && (((String)(localObject21)).length() > 1))) {
                                        try {
                                            try {
                                                i17++;
                                                if (str15.equals("")) {
                    ...
                    int m;
                    if ((paramActionEvent.getSource() == btnEraseData)) {
                    ...
                    else if ((paramActionEvent.getSource() == btnGetCardTopUp)) {
                        ...
                        String str3;
                        if ((paramActionEvent.getSource() == btnDelWayBill)) {
                            ...
                            if ((paramActionEvent.getSource() == btnWayBillNumber)) {
                                try {
                                    ...
                                    while (((ResultSet)(localObject3)).next()) {
                                        model.addRow(new Object[][][] {
                                                    ((ResultSet)(localObject3)).getString(1),
                                                    ((ResultSet)(localObject3)).getString(2),
                                                    ((ResultSet)(localObject3)).getString(3),
                                                    ((ResultSet)(localObject3)).getString(4),
                                                    ((ResultSet)(localObject3)).getString(10),
                                                    ((ResultSet)(localObject3)).getString(5),
                                                    ((ResultSet)(localObject3)).getString(6),
                                                    ((ResultSet)(localObject3)).getString(7),
                                                    ((ResultSet)(localObject3)).getString(8),
                                                    ((ResultSet)(localObject3)).getString(9),
                                                    ((ResultSet)(localObject3)).getString(11)});
                                    }
                                ...
                                if ((paramActionEvent.getSource() == btnUploadWayBill)) {
                                    try {
                                        ...
                                        if ((str4.length() < 82)) {
                                            ...
                                            String.format("%1$-7s", new Object[][][] {
                                                        "san"});
                                            localObject3 = String.format("%1$-7s", new Object[][][] {
                                                        ((String)(tblWayBillDetails.getModel().getValueAt(n, 0)))});
                                            str9 = String.format("%1$-10s", new Object[][][] {
                                                        ((String)(tblWayBillDetails.getModel().getValueAt(n, 1)))});
                                            localObject6 = String.format("%1$-10s", new Object[][][] {
                                                        ((String)(tblWayBillDetails.getModel().getValueAt(n, 2)))});
                                            localObject7 = String.format("%1$-10s", new Object[][][] {
                                                        ((String)(tblWayBillDetails.getModel().getValueAt(n, 3)))});
                                            localObject8 = String.format("%1$-3s", new Object[][][] {
                                                        ((String)(tblWayBillDetails.getModel().getValueAt(n, 4)))});
                                            localObject9 = String.format("%1$-9s", new Object[][][] {
                                                        ((String)(tblWayBillDetails.getModel().getValueAt(n, 5)))});
                                            str11 = String.format("%1$-2s", new Object[][][] {
                                                        ((String)(tblWayBillDetails.getModel().getValueAt(n, 6)))});
                                            localObject11 = String.format("%1$-9s", new Object[][][] {
                                                        ((String)(tblWayBillDetails.getModel().getValueAt(n, 7)))});
                                            localObject12 = String.format("%1$-2s", new Object[][][] {
                                                        ((String)(tblWayBillDetails.getModel().getValueAt(n, 8)))});
                                            localObject13 = String.format("%1$-4s", new Object[][][] {
                                                        ((String)(tblWayBillDetails.getModel().getValueAt(n, 9)))});
                                            localObject14 = String.format("%1$-16s", new Object[][][] {
                                                        ((String)(tblWayBillDetails.getModel().getValueAt(n, 10)))});
                                            char c = ((char)(endOfString));
                                            if (machineType.equals("BALAJI")) {
                                                conCatenateWayBill = (((String)(localObject3)) 
                                                            + (str9 
                                                            + (((String)(localObject6)) 
                                                            + (((String)(localObject7)) 
                                                            + (((String)(localObject9)) 
                                    ...
                                    Object localObject1;
                                    Object localObject2;
                                    if ((paramActionEvent.getSource() == btnCollectCash)) {
                                        HidePanel();
                                        ...
                                        txtCashCollected.setText(((String)(localObject1)));
                                    }
                                    else {
                                        ...
                                        if ((paramActionEvent.getSource() == btnUploadCouponData)) {
                                            ...
                                            try {
                                                ...
                                                dbmd = db.getMetaData();
                                                sql = db.createStatement();
                                                localObject7 = db.prepareStatement(("select fldv_waybill_no from  tbl_waybill_mst where fldv_conductor_employee_code = \'" 
                                                                + (((String)(localObject2)) + "\' and fldc_status = \'Y\' and fldc_waybill_open_close_status = \'N\' order by flddt_date desc limit 0,1")));
                                                        ...
                                                        if (!((String)(localObject20)).equals("")) {
                                                            ...
                                                            if ((i16 >= 0)) {
                                                                ...
                                                                if (((String)(localObject1)).equals("")) {
                                                                    localObject1 = ("(\'0\',\'\',\'" 
                                                                                + (((String)(localObject2)) + ("\',\'0\',\'" 
                                                                                + (localObject12 + ("\',\'" 
                                                                                + (localObject11 + ("\',\'" 
                                                                                + (str14 + ("\',\'" 
                                                                                + (((String)(localObject20)) + ("\',\'" 
                                                                                + (localObject17 + ("\',\'" 
                                                                                + (str16 + ("\',NOW(),\'N\',\'" 
                                                                                + (sessId + ("\',NOW(),\'" 
                                                                                + (((String)(localObject6)) + "\')"))))))))))))))))));
                                            ...
                                            if ((paramActionEvent.getSource() == btnGetCouponAmount)) {
                                                ...
                                                if (!((String)(localObject1)).equals("")) {
                                                    ...
                                                    try {
                                                        ...
                                                        for (i8 = 0; (i8 < i2); i8++) {
                                                            ...
                                                            localObject19 = db.prepareStatement(("SELECT sum(((fldi_coupon_end_number -  fldi_coupon_next_number)+1)) as totobal FROM tbl_coupon_alloca" +
                                                                "tion_data WHERE fldv_employee_code = \'" 
                                                                            + (((String)(localObject1)) + ("\' and fldc_coupon_completed = \'N\' and fldc_status = \'Y\'  and fldi_coupon_amount = \'" 
                                                                            + (f + ("\' and fldi_coupon_end_number < \'" 
                                                            ...
                                                            localObject21 = db.prepareStatement(("SELECT  (sum((\'" 
                                                                            + (i12 + ("\'- fldi_coupon_next_number)+1)) as totobal1 FROM tbl_coupon_allocation_data WHERE fldv_employee_code " +
                                                                            "= \'" 
                                                                            + (((String)(localObject1)) + ("\' and fldc_coupon_completed = \'N\' and fldc_status = \'Y\'  and fldi_coupon_amount = \'" 
                                                                            + (f + ("\' and (\'" 
                                                            ...
                                                            localObject7 = Float.valueOf((((Float)(localObject7)).floatValue() 
                                                    ...
                                                    try {
                                                        ...
                                                        while (((ResultSet)(localObject4)).next()) {
                                                            ...
                                                            couponModel.addRow(new Object[][][] {
                                                                        ((ResultSet)(localObject4)).getString(4),
                                                                        ((ResultSet)(localObject4)).getString(2),
                                                                        ((ResultSet)(localObject4)).getString(3),
                                                                        localObject6,
                                                                        "0",
                                                                        "0.0",
                                                                        ((ResultSet)(localObject4)).getString(5),
                                                                        ((ResultSet)(localObject4)).getString(6)});
                                                        }
                                                ...
                                                try {
                                                    ...
                                                    if ((!str12.equals("") 
                                                                || !((String)(localObject14)).equals("Emp Code"))) {
                                                        i12 = 0;
                                                        ...
                                                        if (!str12.equals("")) {
                                                            ...
                                                            localObject19 = db.prepareStatement((@"select fldv_waybill_no,fldv_conductor_employee_code,fldv_driver_employee_code,fldv_vehicle_number,fldv_division_name,fldv_division_code,fldv_depot_name,     fldv_depot_code,fldv_schedule,fldv_etm_number,flddt_date from  tbl_waybill_mst where fldv_conductor_employee_code = '" 
                                                                            + (((String)(localObject14)) + "\' and fldc_status = \'Y\' and fldc_waybill_open_close_status = \'N\' order by flddt_date desc limit 0,1")));
                                                            localObject20 = ((PreparedStatement)(localObject19)).executeQuery();
                                                            while (((ResultSet)(localObject20)).next()) {
                                                        ...
                                                        if (!((String)(localObject1)).equals("")) {
                                                            ...
                                                            localObject20 = "";
                                                            localObject21 = db.prepareStatement(("select fldi_conductor_collection_id,fldv_waybill_no from tbl_conductor_collection_amount where fldv_w" +
                                                                "aybill_no = \'" 
                                                                            + (((String)(localObject1)) + ("\' and fldv_etm_number = \'" 
                                                                            + (((String)(localObject11)) + ("\' and fldv_vehicle_number = \'" 
                                                                            + (((String)(localObject5)) + ("\' and fldv_collection_date = \'" 
                                                                            + (((String)(localObject19)) + "\'")))))))));
                                                            localResultSet = ((PreparedStatement)(localObject21)).executeQuery();
                                                            while (localResultSet.next()) {
                                                                i12 = 1;
    ...
    public void getConductorDetails() {
        try {
            ...
            dbmd = db.getMetaData();
            sql = db.createStatement();
            PreparedStatement localPreparedStatement = db.prepareStatement("select fldi_conductor_id,fldv_conductor_name,fldv_employee_code  from tbl_conductor_mst where fldc_st" +
    ...
    public String getCashCollected(String paramString) {
        ...
        try {
            ...
            if (!str.equals("")) {
                ...
                dbmd = db.getMetaData();
                sql = db.createStatement();
                PreparedStatement localPreparedStatement = db.prepareStatement(("select round( sum(fldi_ticket_fare)/100) as totalFare from tbl_trip_ticket_details where flddt_ticket" +
                    "_date = \'" 
                                + (str + "\'")));
                ResultSet localResultSet = localPreparedStatement.executeQuery();
                while (localResultSet.next()) {
